...
export abstract class ITemplateAppStateService extends LocalAppState<ITemplateAppState> {
...
@Injectable()
export class TemplateAppStateService extends ITemplateAppStateService {
  constructor() {
  ...
  public setShowWatched(showWatched: boolean): void {
    const appState: ITemplateAppState = {
      ...this.getAppState(),
      showWatched,
    };
    this.saveAppState(appState);
